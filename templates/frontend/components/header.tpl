{**
 * plugins/themes/pgbcJournalTheme/templates/frontend/components/header.tpl
 * (Cópia de lib/pkp/templates/frontend/components/header.tpl, modificada)
 *
...
<body class="pkp_page_{$requestedPage|escape|default:"index"} pkp_op_{$requestedOp|escape|default:"index"}{if $showingLogo} has_site_logo{/if}" dir="{$currentLocaleLangDir|escape|default:"ltr"}">
    ...
    {* Incluir a Barra Gov.br aqui, antes da estrutura principal da página *}
    {include file="components/govBrBar.tpl"}
        ...
        <header class="pkp_structure_head" id="headerNavigationContainer" role="banner">
            ...
            <div class="pkp_head_wrapper">
                ...
                {capture assign="primaryMenu"}
                    {load_menu name="primary" id="navigationPrimary" ulClass="pkp_navigation_primary pkp_nav_list"}
                {/capture}
